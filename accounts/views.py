        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    #To find the common items in both list
...
def resetPassword(request):
    if request.method == 'POST':
        ...
        if password == confirm_password:
            ...
            user = Account.objects.get(pl=uid)
...
def dashboard(request):
    ...
    # userprofile = UserProfile.objects.get(user_id=request.user.id)'userprofile': userprofile,
    context = {
