...
class NotificationConsumer(AsyncJsonWebsocketConsumer):
	async def connect(self):
		print("NotificationConsumer: connect: " + str(self.scope["user"]) )       #Called when the websocket is handshaking as part of initial connection.
		await self.accept()


	async def disconnect(self, code):
		print("NotificationConsumer: disconnect")    #Called when the WebSocket closes for any reason.
